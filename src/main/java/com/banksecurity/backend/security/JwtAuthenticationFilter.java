    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (StringUtils.hasText(jwt) && tokenProvider.validateToken(jwt)) {
                ...
                // Vérifier que l'ID dans le token correspond à l'utilisateur
                if (userDetails instanceof UserPrincipal &&
                        ((UserPrincipal) userDetails).getId().equals(userId)) {
                    ...
                    log.warn("ID utilisateur dans le token ne correspond pas: {}", username);
                }
            }
        } catch (Exception ex) {
